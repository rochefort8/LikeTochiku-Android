...
public class ParseLoginConfig {
  ...
  public static final String PARSE_LOGIN_EMAIL = "com.parse.ui.ParseLoginActivity.PARSE_LOGIN_EMAIL";
  ...
  private CharSequence parseLoginEmail;
  ...
  public boolean isParseLoginEnabled() {
    ...
    public CharSequence getParseLoginEmail() {
        return parseLoginEmail;
    }

    public void setParseLoginEmail(CharSequence parseLoginEmail) {
        this.parseLoginEmail = parseLoginEmail;
    }
  ...
  public Bundle toBundle() {
    ...
    if (parseLoginInvalidCredentialsToastText != null) {
      ...
      if (parseLoginEmail != null) {
          bundle.putCharSequence(PARSE_LOGIN_EMAIL,
                  parseLoginEmail);
      }
  ...
  public static ParseLoginConfig fromBundle(Bundle bundle, Context context) {
    ...
    if (keys.contains(PARSE_SIGNUP_BUTTON_TEXT)) {
      ...
      if (keys.contains(PARSE_LOGIN_EMAIL)) {
          config.setParseLoginEmail(bundle.getCharSequence(PARSE_LOGIN_EMAIL));
      }
